...
```
dataset obj-schema org.kitesdk.cli.example.Movie -o movie.avsc
```
...
```
dataset csv-schema movie.csv --class Movie -o movie.avsc
```
...
```
dataset create movie --schema movie.avsc
```
...
```
dataset create movie --schema movie.avsc partition-by movie.json
```
...
```
dataset create movie --schema movie.avsc -f parquet
```
...
```
dataset csv-import /kite/example/movie.csv movie
```
...
```
dataset copy movie_parquet movie
```
